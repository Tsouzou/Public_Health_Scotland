...
def main():
        ...
        if filename.endswith('.csv'):
            ...
            try:
                ...
                if 'PaidDateMonth' in df.columns:
                    ...
                    df['PaidDateMonth'] = pd.to_datetime(df['PaidDateMonth'].astype(str), format='%Y%m')
                else:
    ...
    for gp in gp_practices:
        ...
        gp_data = data[data['GPPractice'] == gp].copy()
        if gp_data.empty:
        ...
        for description in bnf_descriptions:
            desc_data = gp_data[gp_data['BNFItemDescription'] == description].copy()
            ...
            for unit in units:
                unit_data = desc_data[desc_data['unit'] == unit].copy()
            ...
            if plt.gca().lines:
                ...
                plt.close()
                print(f"No data to plot for GPPractice '{gp}', BNFItemDescription '{description}'. Skipping plot.")
